...
async function checkLlmHealth() {
  ...
  try {
    ...
    if (d.llm_reachable) {
      ...
      if (urlLbl) urlLbl.textContent = (d.llm_url || '') + ' (unreachable)';
      // Show helpful error in console
      if (d.llm_error) console.warn('[LLM] Health check error:', d.llm_error);
    }
